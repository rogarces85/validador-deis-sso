<!-- SPECKIT START -->
Plan actual Spec Kit: `specs/003-b-crud-reglas/plan.md` (Feature 003-B: CRUD de reglas + publicacion de versiones). Siguiente entrega planificada: 003-C (auditoria no clinica + estadisticas), todas en `specs/003-*/`.
...
- **Convencion de carpetas**:
  ...
  - `scripts/` - Scripts PHP de operacion (migrate, seed-admin, test-auth, test-reglas, import-reglas-initial).
