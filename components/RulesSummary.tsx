...
const SEVERITY_CONFIG: Record<Severity, { label: string; color: string; softBg: string; borderColor: string; solidBg: string; tooltip: string; icon: React.ReactNode }> = {
    ...
    [Severity.INDICADOR]: {
        ...
        solidBg: '#2563EB',
        tooltip: 'INDICADOR: Valor que podría estar afectando el cumplimiento de una meta sanitaria o indicador de gestión del SSO. Se recomienda verificar con el equipo responsable.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
