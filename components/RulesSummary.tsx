            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
                <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="bg-gradient-to-br from-indigo-100 to-blue-200 p-4 rounded-xl doc-icon-container cursor-pointer" title="Documento REM">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-indigo-600 doc-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-1">
                                ...
                                <span className="px-2 py-0.5 bg-slate-100 text-slate-600 text-[11px] font-bold rounded uppercase">{MONTH_NAMES[meta.mes] || meta.mes} {meta.periodo || '2026'}</span>
